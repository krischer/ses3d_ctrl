...
def q_cem(r):
    """
    This is the 1D Q model used in the Comprehensive Earth Model. It is a
    smoothed version of QL6, presented by Durek & Ekstrom (BSSA, 1996).
    """
    a = (6371.0 - r) / 271.0

    if ((r <= 6371.0) & (r >= 6100.0)):

        q = 300.0 - 5370.82 * a ** 2 + 14401.62 * \
            a ** 3 - 13365.78 * a ** 4 + 4199.98 * a ** 5
